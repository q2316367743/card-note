...
(function (c) {
    ...
    var fP = {'report': fj}, fQ = {
        'get': function (fU) {
            return dbStorage.getItem(fU)
        }, 'set': function (fV, fW, fX, fY, fZ, g0) {
            return dbStorage.setItem(fV, fW)
        }
    }, fR = {
        'get': function (g2) {
            return aP['parse'](dbStorage.getItem(g2) || '{}');
        }, 'set': function (g3, g4, g5, g6) {
            return dbStorage.setItem(g3, g4)
        }
    ...
    function iM(iN, iO) {
        ...
        return './51/js-sdk-event.min.js?u='['concat'](iN);
    }
